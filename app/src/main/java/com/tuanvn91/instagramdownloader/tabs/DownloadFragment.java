...
import com.tuanvn91.instagramdownloader.database.InstaImage;
import com.tuanvn91.instagramdownloader.service.DownloadService;
import com.tuanvn91.instagramdownloader.service.FileDownloaderService;
...
//                new DownloadFileFromURL().execute(etURL.getText().toString());
    ...
    public class imageDownloadReceiver extends ResultReceiver {
        ...
        private imageDownloadReceiver(Handler handler) {
            super(handler);
        }
